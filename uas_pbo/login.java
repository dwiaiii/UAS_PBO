...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ex.setBackground(new java.awt.Color(204, 204, 255));
        ex.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        ex.setText("Exit");
        ...
        jLabel4.setText("WELCOME ABSENSI PT UNDIRA");
    ...
    private void logActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_logActionPerformed
        ...
        else if (user.getText().equals("Aiko")&& pass.getText().equals("12345")){
            JOptionPane.showMessageDialog(null, "Berhasil Login");
            
            absensi mhs = new absensi();
            mhs.setVisible(true);
            
            this.dispose();
        }
        else{
            JOptionPane.showMessageDialog(null, "Username atau kata sandi salah","Message", JOptionPane.ERROR_MESSAGE);
        }
